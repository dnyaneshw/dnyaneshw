...
<div>
   <h4>Please enter your Credit card information Below</h4>
    ...
    <fieldset>
        ...
        <ol>
            <li>
                <asp:Label ID="Label1" runat="server" >Amount to Charge :</asp:Label>
                <asp:Label ID="Label2" runat="server" Font-Bold="true" ForeColor="Red" Text="$"></asp:Label>
                <asp:Label ID="lblAmount" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label>
            </li>
            <li>
            ...
            <li>
                ...
                <%--<asp:RequiredFieldValidator CssClass="message-error" Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCardFirstName" ErrorMessage="Please Enter Name On Card." ValidationGroup="REGPay"></asp:RequiredFieldValidator>
                <asp:RequiredFieldValidator CssClass="message-error" Display="Dynamic" ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCardLastName" ErrorMessage="Please Enter Name On Card." ValidationGroup="REGPay"></asp:RequiredFieldValidator>--%>
            ...
            <li>
                <asp:Label ID="Label9" runat="server" AssociatedControlID="txtPZip">*Postal Code :</asp:Label>
                <asp:TextBox ID="txtPZip" autocomplete="off" MaxLength="7" runat="server" ToolTip="Zip"></asp:TextBox>
                <asp:RequiredFieldValidator CssClass="message-error" Display="Dynamic" ID="RequiredFieldValidator19" runat="server" ControlToValidate="txtPZip"
                    ErrorMessage="Please Enter Postal Code" ValidationGroup="REGPay"></asp:RequiredFieldValidator>
