<%@ Page Title="Welcome to dscoverage.ca - Register Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Insurance.Register" %>
...
<asp:Image ID="Image2" runat="server" ImageUrl="~/images/comodo.png" ImageAlign="top" style="height:32px;width:73px;border-width:0px;" /></div>
            </asp:View>
