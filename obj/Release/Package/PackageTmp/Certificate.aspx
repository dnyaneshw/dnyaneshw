...
<body>
    <form id="form1" runat="server">
        ...
        <table border="1" width="100%" align="center" style="font-family: Tahoma;">
            ...
            <tr>
                <td width="400" valign="top" style="font-size: small; padding-left: 20px;">
                    <b>PRODUCER</b>
                    <span><br/>
                    WADDELL INSURANCE BROKERS LIMITED<br/>
                    110 Matheson Blvd. West, Ste. 202<br/>
                    Mississauga, Ontario   L5R 4G7<br/>
                    </span>
                </td>
            ...
            <tr>
                ...
                <td style="font-size: small">
                    <table border="1" width="100%" style="font-size: 13px">
                        ...
                        <tr valign="bottom">
                            <td>
                                <b>INSURER A:</b> ECONOMICAL INSURANCE COMPANY</td>
                            <td>..............
                            </td>
                        </tr>
                        <tr valign="bottom">
        ...
        <table border="1" width="100%" align="center" style="font-family: Tahoma">
            ...
            <tr style="font-size: x-small">
                ...
                <input type="checkbox" name="c3" checked="checked" style="width: 30px; height: 20px;" />OCCURRENCE<br/>
                    <input type="checkbox" name="c4" style="width: 30px; height: 20px;" checked="checked" />LIABILITY IS SUBJECT TO A $200 DEDUCTIBLE<br/>                   
                    <br />
                ...
                <td valign="middle" align="center" class="auto-style11">501395383</td>
        ...
        <table border="1" align="center" width="100%" style="font-family: Tahoma; font-size: small">
            ...
            <tr>
                <td valign="top">
                    ...
                    <br />
                    <br />
                    BRIAN WADDELL &nbsp;&nbsp; WADDELL INSURANCE BROKERS LIMITED                    
                </td>
            </tr>
        </table>
        ...
        <table border="1" align="center" width="100%" style="font-size: small; height: 100px">
            <tr valign="top">
                <td style="width: 50%" colspan="3">AGENCY :&nbsp; WADDELL INSURANCE BROKERS LIMITED
                </td>
            ...
            <tr valign="top">
                <td colspan="3">POLICY NUMBER :&nbsp; BMW1984</td>
            </tr>
            <tr>
                <td colspan="2">CARRIER :&nbsp; ECONOMICAL INSURANCE COMPANY</td>
                <td>NAIC CODE : 
                </td>
                <td>EFFECTIVE DATE :&nbsp;
