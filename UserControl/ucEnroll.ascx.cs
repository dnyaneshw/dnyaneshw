    ...
    public partial class ucEnroll : System.Web.UI.UserControl
    {
        ...
        public bool IsValidate()
        {
            ...
            else if (drpStates.SelectedItem.Text.Equals("--Select--"))
            {
                ...
                lblState.Text = "Please Select Province or Territory from List.";
                return false;
            }
            ...
            if ((txtZipCode.Text.Length != 7) || (!Regex.IsMatch(txtZipCode.Text, @"[ABCEGHJKLMNPRSTVXYabceghjklmnprstvxy][0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyz] ?[0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyz][0-9]$")))
            {
                lbl1.Visible = true;
                RequiredFieldValidator25.Style.Value = "display:none;";
                lbl1.Text = "Enter Valid Postal Code Format.";
                return false;
            }
