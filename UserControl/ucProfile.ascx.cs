    ...
    public partial class ucProfile : System.Web.UI.UserControl
    {
        ...
        private bool IsValidate()
        {
            ...
            else if (drpStates.SelectedItem.Text.Equals("--Select--"))
            {
                ...
                lblStaterror.Text = "Please Select Province or Territory from List.";
                return false;
            }
            else if (txtZipCode.Text == "")
            {
                lblError.Visible = true;
                lblError.Text = "Please Enter Postal Code";
                return false;
            }
            else if ((txtZipCode.Text.Length != 7) || (!Regex.IsMatch(txtZipCode.Text, @"[ABCEGHJKLMNPRSTVXYabceghjklmnprstvxy][0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyz] ?[0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyz][0-9]$")))
            {
                lbl1.Visible = true;
                lbl1.Text = "Please Enter Valid Postal Code..";
                return false;
            }
